...
class UserController extends Controller
{
    ...
    public function downloadTemplate()
    {
        ...
        $data = [
            ['Name', 'Email', 'Password', 'Role', 'NIS/NIDN', 'Angkatan/NUPTK', 'Kelas/Mapel', 'Wali_Kelas_ID/Telepon'], // Header
            ['Contoh Siswa', 'siswa@example.com', 'password123', 'siswa', '12345', '2024', 'X RPL 1', '1'], // Contoh Data 1
            ['Contoh Guru', 'guru@example.com', 'password123', 'guru', '98765', '12345678', 'Matematika', '08123456789'], // Contoh Data 2
        ];
