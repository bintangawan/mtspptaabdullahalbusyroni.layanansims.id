...
class SectionImport implements ToModel, WithBatchInserts, WithChunkReading, WithValidation, WithStartRow // <--- Tambahkan WithStartRow
{
    ...
    {
        return 2; // Data dimulai dari baris ke-2 (Baris 1 adalah Header)
    }
    ...
    public function rules(): array
    {
        return [
            ...
            '2' => 'required|string|exists:terms,tahun', // Validasi tambahan: pastikan tahun ada di terms
    ...
    {
        return [
            '0.exists' => 'Kode mata pelajaran tidak terdaftar di sistem.',
            '1.exists' => 'Email guru tidak terdaftar di sistem.',
            '2.exists' => 'Tahun ajaran belum dibuat di Master Data Term.',
        ];
    }
}